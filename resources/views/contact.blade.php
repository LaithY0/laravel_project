...
@section('page')
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('myimg/w-rum.jpg');" data-stellar-background-ratio="0.5">
        ...
        <div class="row d-flex contact-info">
          ...
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="tel://1234567920">+ 962799988990</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="Priceline@email.com">Priceline@email.com</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 text-center">
